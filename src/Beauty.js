...
function Beauty(){
    ...
    <div className="pagesheaddiv rounded col-10 m-auto p-3 pb-1 pt-4 text-center">
        <h1 className='toptitle'>BEAUTY</h1>
    </div>
        <br></br>
        {/* main column */}
        <div className='m-auto col-10 d-flex text-center'> 
            ...
            <div className='d-flex flex-wrap col-12 justify-content-between '> 
                    ...
                    <div className='d-flex col-12 flex-wrap'>
                        <div className='d-flex col-12 flex-wrap flex-lg-nowrap'>
                            ...
                            <Link onClick={scrollToTop} to="/beauty" className="text-decoration-none fs-5 fw-lighter text-dark linkpink">beauty</Link>
                                ...
                                <Link onClick={scrollToTop} to="/article7">
                                <div class="cardofoutercss d-flex flex-wrap">                                  
                                    <i className='fs-3 fw-light'>Hair Care</i><br></br>                                    
                                    <img src='beauty.jpg' className='img-fluid' alt='gridimg'></img>                          
                            ...
                            <Link onClick={scrollToTop} to="/beauty" className="text-decoration-none fs-5 fw-lighter text-dark linkpink">beauty</Link>
                                ...
                                <Link onClick={scrollToTop} to="/article8">
                                <div class="cardofoutercss d-flex flex-wrap">  
                                    <i className='fs-3 fw-light'>Skin Care</i><br></br>
                                    <img src='beauty2.jpg' className='img-fluid' alt='gridimg'></img>
                                    <p className='fs-4 m-3 fw-lighter'>July 17</p>
                                </div>
                                </Link>
                            </div>
                        ...
                        <div className='d-flex col-12 flex-wrap flex-lg-nowrap'>
                            ...
                            <Link onClick={scrollToTop} to="/beauty" className="text-decoration-none fs-5 fw-lighter text-dark linkpink">beauty</Link>
                                ...
                                <Link onClick={scrollToTop} to="/article9">
                                <div class="cardofoutercss d-flex flex-wrap">  
                                    <i className='fs-3 fw-light'>Guide to achieve the Perfect body</i><br></br>
                                    <img src='beauty3.jpg' className='img-fluid' alt='gridimg'></img>
                                    <p className='fs-4 m-3 fw-lighter'>July 17</p>
                                </div>
                                </Link>
                            </div>
                        ...
                        <div className='d-flex col-12 flex-wrap flex-lg-nowrap'> */}
                            ...
                            <Link onClick={scrollToTop} to="/beauty" className="text-decoration-none fs-5 fw-lighter text-dark linkpink">beauty</Link>
                                ...
                                <Link onClick={scrollToTop} to="/article">
                                <div class="cardofoutercss d-flex flex-wrap">  
                                    <i className='fs-3 fw-light'>Brand to Know: Larsson and Jennings</i><br></br>
                ...
                <div className='col-12 col-md-3'>
                    ...
                    <samll>BEAUTY    .</samll> <small className='ffont fw-light'>favourites</small>
                    </div>
                            ...
                            <div className='me-lg-5 col-12 mb-5 rounded'><br/>
                                        ...
                                        <div>         
                                            {/* row1 */}     
                                                ...
                                                <div className='col-6'>
                                                    <Link onClick={scrollToTop} to="/article"><img src="sidecol.jpg" alt="img" className='img-fluid'></img></Link>
                                                </div>
                                                <p className='col-6 fs-6 align-self-center'>fjeirnge rngeiunr</p>
                                                </div> */}
                                            {/* row-2 */}
                                            <br></br>
                                            <div>
                                            ...
                                            <div className='d-flex col-10 m-auto border border-dark border-1'> 
                                            <div className='col-6'>
                                            <Link onClick={scrollToTop} to="/article9"><img src="beauty3.jpg" alt="img" className='img-fluid'></img></Link>
                                            </div>
                                            <p className='col-6 fs-6 align-self-center'>Guide to achieve the Perfect body</p>
                                            </div>  
                                        </div>           
                            </div>
                    </div>
